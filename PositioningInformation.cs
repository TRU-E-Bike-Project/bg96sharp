...
namespace BG96Sharp
{
    public readonly struct PositioningInformation
    {
        ...
        public PositioningInformation(string result)
        {
            ...
            Date = DateTime.ParseExact(regex.Groups[1].Value + " " + regex.Groups[12].Value, "HHmmss.ffff ddMMyy", CultureInfo.InvariantCulture, DateTimeStyles.AssumeUniversal);
        }
    }
}